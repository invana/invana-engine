...
import graphene
from invana_engine2.core.schema_generator import DynamicSchemaGenerator
from invana_engine2.core.utils import convert_to_graphql_schema
from .graph import graph
from invana_engine2.modeller.query import ModellerQuery
from invana_engine2.graph.query import GraphSchema
from invana_engine2.core.store import SchemaStore
from invana_engine2.graph.mutation import MutationSchema
...
def get_schema():
    ...
    return schema_generator.create_schema_dynamically(query_classes=[ModellerQuery, GraphSchema],
                                                      mutation_classes=[MutationSchema, ])
