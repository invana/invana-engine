...
from invana_engine.auth import TokenAuth, BasicAuth
import os
import json
...
if __name__ == "__main__":
    token_auth = BasicAuth(username="user", password="password")
    gremlin_url = os.environ.get("GREMLIN_SERVER_URL", "ws://192.168.0.10:8182/gremlin")
    star_graph = StoryOfStarsGraph(gremlin_url, auth=token_auth)
