...
from invana_engine.invana.gremlin.querysets.vertex import GremlinVertexQuerySet
from invana_engine.invana.gremlin.querysets.edge import GremlinEdgeQuerySet
# from ..serializer.element_structure import Node, RelationShip
from .utils import get_absolute_field_name
import abc
if TYPE_CHECKING:
    from invana_engine.invana.graph import InvanaGraph
