...
class QueryGenerators:
    ...
    def create_node_type_filters(self, NodeType: graphene.ObjectType, 
                                type_def: InvanaGQLLabelDefinition,
                                extra_fields=None):
        extra_fields = {} if extra_fields is None else extra_fields
        node_fields = {}
        node_fields.update(extra_fields)
    ...
    def create_node_object_type_with_filters(self, 
        ...
        node_fields = self.create_node_type_filters(NodeType, type_def, extra_fields=extra_fields)
        NodeTypeWithAllFields  = type(type_def.label, (graphene.ObjectType, ), node_fields)
        return NodeTypeWithAllFields
