...
import abc
from abc import ABC
from invana_engine.backends.base.transporter.constants import RequestStateTypes, QueryResponseStatusTypes,\
    GremlinServerErrorStatusCodes 
# from invana_engine.invana.connector.request import QueryRequest
from invana_engine.utils.utils import create_uuid, get_datetime, get_elapsed_time
import logging
